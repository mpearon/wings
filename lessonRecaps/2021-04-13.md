...
## Landing
After I ran through slow flight a few times and several of each type of stall, we headed back toward the airport.<br />
John took this time to show me how N8222F's digital instruments worked. The Directional Gyro and Attitude Indicator had been replaced with a consolidated unit made by Garmin.  
> **Note:** Surprisingly, I didn't like this Garmin unit. Being a technical person, I generally love anything with an LCD and a couple of buttons - but this appears to be the exception.<br />
I was looking to the traditional turn coordinator to ensure that my turn was "pretty", but John was referencing the indicator that the Garmin had integrated to the top of the attitude indicator (easier for him to see from the right seat, I'm sure).  The digital unit was maybe a little quicker to update, so it felt like I was behind.<br />
I'll probably get more comfortable with these as I spend time with them.

It was around this time that we discovered that the instrument lights were mostly non-functional in N8222F.  Part of the preflight requires that you ensure that these lights are functional - but depending on how bright it is when you check that, it's hard to see if they are all actually lit. In this case, the right side of the panel was lighting (the side I checked earlier), but the middle and left sides were not.<br />
Anyway, he set a heading bug to the runway heading and off we went.  He was having to remind me to continue descending, because my natural posture is a slight climb, evidently.  As the airport came into view, he started giving me instruction on how to line the plane up with the middle of the runway while managing the flaps and descent.  I guided the plane to the runway, then he took the controls for the touchdown.
> **Note:** John's advice was while I'm on the approach to the runway, aim the plane at the numbers. Once I'm over the numbers, I should adjust my gaze to mid-length of the runway.
