...
- Request Taxi clearance from ATC
	```
	"Jeff Tower, Warrior 8248Tango on ramp, requesting taxi to runway 12"
	```
...
- Request Takeoff Clearance from ATC
	```
	"Jeff Tower, Warrior 8248Tango on Alpha, requesting takeoff on runway 12"
	```
- Start Fuel Clock
### Takeoff
- Taxi onto runway
...
- Continue climb until at pattern altitude
## Climbs
